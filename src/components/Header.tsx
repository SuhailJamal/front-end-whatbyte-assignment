...
const Header = () => {
  return (
    <>
      <nav className="flex justify-between items-center bg-blue-900 text-white p-4 px-2 md:px-14">
        <div className="font-bold text-lg md:text-4xl">Logo</div>
        <div className="flex justify-center gap-4 md:gap-10">
          <div className="flex items-center border border-white rounded-md bg-blue-900 h-12 px-3 w-[180px] md:w-[400px]">
